	...
	NANOSECONDS() {
		...
		public double convert(double value, TrackTimeUnit source) {
			switch (source) {
				...
				case SECONDS: return value * TimeUnit.SECONDS.toNanos(1);
				default: throw TrackTimeUnit.prepareUnsupportedException(source, this);
			}
		}
	},
	SECONDS() {
		...
		public double convert(double value, TrackTimeUnit source) {
			switch (source) {
				...
				case NANOSECONDS: return value / TimeUnit.SECONDS.toNanos(1);
				default: throw TrackTimeUnit.prepareUnsupportedException(source, this);
			}
		}
	};
